...
export const t = {
  en: {
    ...
    hero: {
      ...
      subheadline:
        "Conjuncture's model is trained on 358,804 real awarded Thai government procurement contracts — so you know exactly what discount wins, before you submit.",
  ...
  th: {
    ...
    hero: {
      ...
      headline: "ประมูลชนะ\nด้วยข้อมูลจริง\nไม่ต้องเดา",
      subheadline:
        "โมเดลของ Conjuncture ฝึกด้วยสัญญาจัดซื้อจัดจ้างภาครัฐจริงที่ประมูลสำเร็จแล้ว 358,804 สัญญา — รู้ว่าต้องเสนอส่วนลดเท่าไรจึงชนะ ก่อนยื่นราคา",
