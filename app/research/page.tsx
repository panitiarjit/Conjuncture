...
const FINDINGS_TH = [
  {
    n: '01',
    stat: '218×',
    title: 'ส่วนลดหายไปไหน',
    body: 'ส่วนลดมัธยฐานปีงบประมาณ 2561: 13.12% ถึงปี 2567: 0.06% ในหกปี ส่วนลดมัธยฐานลดลง 218 เท่า ประเภทสัญญาเดิม หน่วยงานเดิม ข้อมูลบอกว่า "เปลี่ยนแปลง" ไม่ใช่ "เพราะอะไร"',
    table: [
  ...
  },
  {
    ...
    body: 'จาก 1,070 สัญญา e-bidding ที่วิเคราะห์ 36.1% จบที่ส่วนลดน้อยกว่า 0.5% จากราคากลาง วิธีจัดซื้อที่ออกแบบมาเพื่อบังคับการแข่งขัน — แต่ผลลัพธ์ไม่ต่างจากการกำหนดราคาตายตัวในมากกว่าหนึ่งในสามของสัญญา',
    bullets: [
      'กรมทางหลวง: 63.9% ของสัญญามีส่วนลดใกล้ศูนย์',
  ...
  },
  {
    n: '03',
    stat: '97%',
    title: 'บุคคลเดียว ศูนย์พัฒนาเด็กเล็ก 4 แห่ง ส่วนลด 97%',
    body: 'ในปีงบประมาณ 2567 บุคคลคนเดียวชนะการประมูลจากศูนย์พัฒนาเด็กเล็ก 4 แห่งที่ต่างกัน ทั้งหมดมีราคากลาง ฿308,700 เหมือนกัน และทั้งหมดมีส่วนลด 96–97%',
    table: [
      ['บ้านสะพังกร่าง', '฿308,700', '฿8,078', '97.38%'],
      ['บ้านรางกร่าง', '฿308,700', '฿9,154', '97.03%'],
      ['บ้านขื่อชนก', '฿308,700', '฿9,154', '97.03%'],
  ...
  },
  {
    ...
    body: 'ในปีงบประมาณ 2567 อบต.เสมา มอบสัญญาก่อสร้างถนนราคากลาง ฿46,133,040 ให้กับห้างหุ้นส่วนจำกัดอุดหนุนการโยธา ในราคา ฿461,330 — ส่วนลด 99% ราคาที่ชนะคือ 1% ของราคาประมาณการของรัฐ',
  ...
  },
  {
    ...
    body: 'ส่วนลดมัธยฐานต่างกัน 121 เท่า ระหว่างจังหวัดที่มีการแข่งขันต่ำสุดและสูงสุด กลยุทธ์ราคาที่เหมาะสมในสระบุรีและพิจิตรต้องต่างกันอย่างมีนัยสำคัญ',
    table: [
      ['สระบุรี', '0.09%', '273'],
      ['แม่ฮ่องสอน', '0.14%', '50'],
      ['ยโสธร', '0.17%', '122'],
  ...
  },
  {
    ...
    body: 'ความเชื่อทั่วไปว่าโครงการใหญ่ดึงดูดผู้รับเหมามากกว่า — ไม่จริง โครงการ 1–10 ล้านมีส่วนลดมัธยฐานสูงสุด โครงการเล็กมากและใหญ่มากต่างมาบรรจบกันที่ส่วนลดใกล้ศูนย์',
    table: [
