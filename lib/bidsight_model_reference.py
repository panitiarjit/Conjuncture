"""
BidSight — corrected bid-recommendation model (Python reference).
...
For production: refit benchmark tables from Firestore/Sheets data only on tenders
dated BEFORE the current one (no leakage). Fall back to global quantiles for tenders
without sufficient agency×category history.
"""
import numpy as np, pandas as pd
from math import erf, sqrt

# Fit empirical benchmark tables from history
