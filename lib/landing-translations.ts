...
export const t = {
  en: {
    ...
    hero: {
      ...
      subheadline:
        "Conjuncture benchmarks your bid against 251,000+ real Thai government procurement projects — so you know exactly what discount wins, before you submit.",
  ...
  th: {
    ...
    hero: {
      ...
      headline: "ประมูลชนะ\nด้วยข้อมูลจริง\nไม่ต้องเดา",
      subheadline:
        "Conjuncture เปรียบเทียบราคาเสนอของคุณกับโครงการจัดซื้อจัดจ้างภาครัฐจริง 251,000+ โครงการ — รู้ว่าต้องเสนอส่วนลดเท่าไรจึงชนะ ก่อนยื่นราคา",
